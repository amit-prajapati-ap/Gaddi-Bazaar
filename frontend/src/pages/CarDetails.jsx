...
const CarDetails = () => {
  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 my-16 max-w-[1200px]'>
      <button onClick={() => navigate(-1)} className='flex items-center gap-2 mb6 text-gray-500 cursor-pointer'>
